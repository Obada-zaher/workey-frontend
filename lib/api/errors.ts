export type ApiErrorCode = "network" | "invalid_json" | "not_found" | "validation" | "server" | "service_unavailable" | "unknown";
...
export function apiErrorForStatus(status: number, message: string): ApiError {
  const codes: Record<number, ApiErrorCode> = { 404: "not_found", 422: "validation", 500: "server", 503: "service_unavailable" };

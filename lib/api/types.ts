...
export interface HomeCompany { id: number | null; name: string | null; logo_url: string | null; cover_image_url?: string | null; }
...
export interface FeaturedCompany { id: number; name: string; logo_url: string | null; cover_image_url?: string | null; industry: string | null; location: string | null; open_jobs_count: number; }
...
export interface Company { id: number; name: string; industry: string | null; location: string | null; logo_url?: string | null; cover_image_url?: string | null; }
